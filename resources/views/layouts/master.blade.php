                    ...
                    <div class="collapse navbar-collapse bg-success" id="collapsibleNavId">
                        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="dropdownId" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Produit</a>
                                <div class="dropdown-menu" aria-labelledby="dropdownId">
                                    <a class="dropdown-item" href="{{ route('produit.liste') }}">Liste produit</a>
                                    <a class="dropdown-item" href="{{ route('ajouter-produit') }}">Ajouter Produit</a>
